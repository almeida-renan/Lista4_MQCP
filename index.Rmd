...
O conjunto de dados é constituído por tweets de candidatos à presidência nas eleições de 2018
...
- Calculamos duas medidas de posição (média e mediana) dos Índices de Interações no Twitter de cada candidato e criamos um novo objeto com esses valores.

```{r, echo=TRUE, warning=FALSE, message=FALSE}
# Calculando a média e a mediana dos índices de cada candidato
...
- Também podemos ver observar a evolução dos valores do Índice ao longo do tempo
